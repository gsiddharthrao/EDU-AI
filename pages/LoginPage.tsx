...
const LoginPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // If the user object becomes available (meaning login was successful and profile is loaded),
        // we navigate to the dashboard. This also handles the case where a logged-in user
        // tries to visit the login page.
        if (user) {
